...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobListing.location_latitude'
        db.add_column(u'jobs_joblisting', 'location_latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)

        # Adding field 'JobListing.location_longitude'
        db.add_column(u'jobs_joblisting', 'location_longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobListing.location_latitude'
        db.delete_column(u'jobs_joblisting', 'location_latitude')

        # Deleting field 'JobListing.location_longitude'
        db.delete_column(u'jobs_joblisting', 'location_longitude')
